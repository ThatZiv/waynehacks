...
function FAQ() {
  const list: FAQList = {
    ...
    "How much does it cost?":
      "The event is completely free, with both free and paid parking available and food during the span of the event.<br/>\n" +
      "You may stay overnight as well.",

    "Will we have a place to work?":
      "Yes, we'll have the entire building to ourselves, including into the night.",
